  ...
  function handleSubmit() {
    form
      ...
      .then((values: LocationFormValues) => {
        // Fluxo: formulário -> payload -> service -> API -> atualização da tela.
        onSubmit(values)
      })
      .catch(() => undefined)
  }
        ...
        <FormGrid>
          <Form.Item
            ...
            rules={[
              ...
              {
                pattern: /^[A-Z0-9-]{2,20}$/,
                message: 'Use 2 a 20 caracteres: letras maiúsculas, números e hífen.',
              },
            ]}
          >
          ...
          <Form.Item
            label="Situação *"
            name="status"
            rules={[{ required: true, message: 'Selecione a situação do local.' }]}
          >
            <Select
          ...
          <Form.Item label="Prédio" name="building">
            <Input placeholder="Ex: Bloco Administrativo" />
          </Form.Item>
